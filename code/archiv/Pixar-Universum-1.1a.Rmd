...
mmego <- mickey_ego[[1]]
plot(mmego, vertex.size=10, edge.width=1, vertex.label.cex=0.6, vertex.frame.color=rgb(0,0,0,alpha=0.3),
     vertex.frame.width=0.8,
    edge.width=0.6,
     label.dist=1,
...
plot(rbrks_ego[[1]], rescale=FALSE, vertex.label.cex=0.5, edge.width=1, layout=dmrego*1.8) #Plot Ralph Ego mit deg < 2
plot(rbrkssm, rescale=FALSE, vertex.label.cex=0.5, edge.width=1, layout=dmrsm*1.8) #Plot Ralph Ego mit deg < 2
plot(rbrks_egosm[[1]], rescale=FALSE, vertex.label.cex=0.5, edge.width=1, layout=dmresm*1.8) #Plot Ralph Ego mit deg < 2

plot(rbrksi, rescale=FALSE, vertex.label.cex=0.5, edge.width=1, layout=dmrego*1.8, main="Ego-Netzwerk Ralph Breaks The Internet", vertex.size= 40*(betweenness(rbrksi) / 44000 + 0.2)) #Plot Ralph Ego mit deg < 2
