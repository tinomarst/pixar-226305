...
V(disnet)[V(disnet)$art == 1]$shape <- "rectangle"
V(disnetma)[V(disnetma)$art == 1]$color <- "gold"
V(disnetma)[V(disnetma)$art == 1]$shape <- "rectangle"

#Einstellungen für Figuren
V(disnet)[V(disnet)$art == 2]$color <- "blue"
V(disnet)[V(disnet)$art == 2]$shape <- "circle"

#Einstellungen für Gegenstände
V(disnet)[V(disnet)$art == 4]$shape <- "rectangle"
V(disnet)[V(disnet)$art == 4]$color <- "gold"
...
plot(a113_ego[[1]]) #Plot Monsters University mit deg < 2
plot(a113sm) #Plot Monsters University mit deg < 2
plot(a113_egosm[[1]]) #Plot Monsters University mit deg < 2
...
par(mfrow=c(1,3)) #Anzeige für zwei Netzwerke partitionieren
plot(rbrks_ego[[1]]) #Plot Monsters University mit deg < 2
plot(rbrkssm) #Plot Monsters University mit deg < 2
plot(rbrks_egosm[[1]]) #Plot Monsters University mit deg < 2
