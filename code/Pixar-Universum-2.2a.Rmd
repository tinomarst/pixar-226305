...
par(mar=c(0,2,2,1))
plot (disraw, layout=rawzoom*1.4, rescale=F, vertex.size=5, vertex.frame.width=0.01, edge.width=0.3, vertex.label.cex=0.4)
```
...
par(mfrow=c(1,1), mar=c(0,0,0,0)) #Anzeige für zwei Netzwerke partitionieren
